  ...
  return (
    <main className="flex flex-col justify-between">
      ...
      <div className="flex flex-col justify-between items-center bg-header-image xl:bg-header-image-2x bg-cover h-[500px] border-b-[32px] border-green-one">
        <div className="flex items-center justify-between nav pt-16 w-[90%]">
          <a>APPOINTMENTS</a>
        ...
        {/* Logo */}
        <img className="mx-auto max-w-[600px] w-[80%] relative top-6" src="/UtahGrownLogoWhiteBorder@2x.png"></img>
      </div>
      
      {/* Upcoming Events */}
      <div className="flex items-center justify-between flex-col space-y-4 pt-4 max-w-[800px] w-full mx-auto">
        <h3 className="text-2xl">Utah's Cannabis Community</h3>
        <h1 className="text-4xl font-semibold py-4">Upcoming Utah Medical Card Events</h1>
        <div className="flex flex-col items-center justify-between space-y-4 w-full text-green-two text-lg">
          <div className="flex items-center bg-grey-three border border-grey rounded-lg w-full py-4">
            <p className="pl-8 w-[22%] text-center">Downtown<br/>SLC</p>
            <div className="flex flex-col px-8 w-[55%]">
          ...
          <div className="flex items-center bg-grey-three border border-grey rounded-lg w-full py-4">
            <p className="pl-8 w-[22%] text-center">Price UT</p>
            <div className="flex flex-col px-8 w-[55%]">
          ...
          <div className="flex items-center bg-grey-three border border-grey rounded-lg w-full py-4">
            <p className="pl-8 w-[22%] text-center">&lt;Other Location&gt;</p>
            <div className="flex flex-col px-8 w-[55%]">
      ...
      <div className="flex flex-col items-center justify-between max-w-[800px] w-full mx-auto mt-16 font-medium">
        <h1 className="text-3xl">Things to know before your appointment</h1>
        <div className="flex w-full space-x-8 mt-8">
          ...
          <div className="flex flex-col space-y-4 pt-6">
            ...
            <div className="flex items-center">
              <div className="btn-primary px-0 py-2 w-44 text-center mr-8">UtahID.org</div>
              <p>Obtain access to your Utah Digital ID</p>
            </div>
            <div className="flex items-center">
              <div className="btn-primary px-0 py-2 w-44 text-center mr-8">EVS.Utah.gov</div>
              <p>Fill out all the fields until you get to “Awaiting Certification” status</p>
            </div>
            <img className="max-w-[200px] mx-auto relative right-[60px]" src="/AwaitingCert-Image.png"></img>
          </div>
        </div>
        ...
        <div className="flex w-full space-x-8 mt-16">
          ...
          <div className="flex flex-col mt-6 space-y-4">
            ...
            <ol className="list-decimal self-center space-y-2 pl-20">
              <li>QMP Registration</li>
              <li>Medical Evaluation/Consultation</li>
              <li>Payment</li>
      ...
      <div className="flex max-w-[900px] self-center mt-16">
        <img className="max-w-half" src="/Consultation.png"></img>
        <div className="flex flex-col pl-12 pt-4">
          <h1 className="font-medium text-[44px]">Utah Medical Cards</h1>
          <p className="font-medium text-grey-two leading-8 pr-4">
      ...
      <div className="w-full max-w-[900px] self-center bg-review-banner bg-cover h-[124px] flex flex-col mt-20 py-4 px-8">
        <h1 className="text-4xl text-tan-two">We'd love to hear from you!</h1>
        <div className="max-w-56 btn-primary text-green-two font-light text-center text-xl py-2 mt-2">Review Us Here!</div>
      </div>

      {/* FAQ */}
      <div className="w-full max-w-[900px] self-center flex flex-col mt-16">
        <h1 className="font-semibold text-4xl">FAQs</h1>
        <ul className="pt-4 text-green-two text-xl space-y-1">
      ...
      <div className="w-full max-w-[900px] self-center mt-16 font-medium text-grey-two flex flex-col space-y-4 overflow-hidden">
        <h1 className="font-semibold text-4xl text-green-one">Utah Medical Cannabit Pharmacies</h1>
        
        <div className="items-center justify-between grid grid-cols-4">
          <div className="flex flex-col col-span-2">
            <h3 className="text-green-two text-xl">DragonFly Wellness</h3>
          ...
          <a>www.dragonflywellness.com</a>
        </div>

        <div className="items-center justify-between grid grid-cols-4">
          <div className="flex flex-col col-span-2">
            <h3 className="text-green-two text-xl">Bloc Pharmacy</h3>
          ...
          <a>www.blocdispensary.com</a>
        </div>
        
        <div className="items-center justify-between grid grid-cols-4">
          <div className="flex flex-col col-span-2">
            <h3 className="text-green-two text-xl">Beehive Farmacy</h3>
          ...
          <a>www.beehivefarmacy.com</a>
        </div>

        <div className="items-center justify-between grid grid-cols-4">
          <div className="flex flex-col col-span-2">
            <h3 className="text-green-two text-xl">Cannabist</h3>
          ...
          <a>www.gocannabist.com</a>
        </div>
        
        <div className="items-center justify-between grid grid-cols-4">
          <div className="flex flex-col col-span-2">
            <h3 className="text-green-two text-xl">Curaleaf</h3>
          ...
          <a>www.curaleaf.com</a>
        </div>
        
        <div className="items-center justify-between grid grid-cols-4">
          <div className="flex flex-col col-span-2">
            <h3 className="text-green-two text-xl">The Flower Shop</h3>
          ...
          <a>www.theflowershopusa.com</a>
        </div>

        <div className="items-center justify-between grid grid-cols-4">
          <div className="flex flex-col col-span-2">
            <h3 className="text-green-two text-xl">WholesomeCo</h3>
          ...
          <a>www.wholesome.co</a>
        </div>

        <div className="items-center justify-between grid grid-cols-4">
          <div className="flex flex-col col-span-2">
            <h3 className="text-green-two text-xl">Zion Medicinal</h3>
      ...
      {/* About */}
      <div className="w-full max-w-[900px] self-center flex mt-32">
        ...
        <img className="max-w-half relative top-4" src="/NormalizeItUtah.png"></img>
      </div>
      ...
      <footer className="flex flex-col">
        <div className="flex items-baseline max-w-[900px] w-full mx-auto pl-8 py-2">
          <img className="h-[100px]" src="/UtahGrownLogo-Green.png"></img>
          <span className="pl-8 text-green-two">UTAH'S CANNABIS COMMUNITY</span>
        </div>
        <div className="flex bg-green-one text-white font-light h-24 justify-end pr-[10%] pt-4 space-x-8">
